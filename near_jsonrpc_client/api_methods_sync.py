...
class APIMixinSync:
    ...
    def experimental_indexer_block(self: NearBaseClientSync, *, params: near_jsonrpc_models.RpcIndexerBlockRequest) -> near_jsonrpc_models.RpcIndexerBlockResponse:
        """
    ...
    def experimental_light_client_chunk_execution_proof(self: NearBaseClientSync, *, params: near_jsonrpc_models.RpcLightClientChunkExecutionProofRequest) -> near_jsonrpc_models.RpcLightClientChunkExecutionProofResponse:
        """
    ...
    def tx_status(self: NearBaseClientSync, *, params: near_jsonrpc_models.RpcTransactionStatusRequest) -> near_jsonrpc_models.RpcTransactionResponse:
        """
